...
class KalmanFilter:
    def __init__(self, y_Measure_init, m = 0.1, step_time = 0.1, Q_x = 0.1, Q_v = 0.1, R = 1.0, P_0 = 10.0):
...
if __name__ == "__main__":
    ...
    y_estimate = KalmanFilter(signal.y_measure[0], Q_x = 0.001, Q_v = 0.02, R = 1.0, P_0 = 1.0)
